    ...
    <div id="container">
        <div class="header fade">
            <header class="header_tit">
                ...
                <a href="#" class="btn_my"> <span title="예약확인">예약확인어디지</span> </a>
            </header>
        </div>
        <div class="ct main">
            <div>
                ...
                <div class="section_review_list">
                    ...
                    <a class="btn_review_more" href="review?id=<%=id%>"> <span>예매자 한줄평 더보기</span> <i class="fn fn-forward1"></i> </a>
                </div>
...
<script type="myTemplate" id="comments">
	{{#each comments}}
	<li class="list_item">
		<div>
			...
			{{/if}}
			<div class="info_area">
				<div class="review_info"> <span class="grade">{{toDouble this.score}}</span> <span class="name">{{email this.reservationEmail}}</span> <span class="date">{{ this.reservationDate}} 방문</span> </div>
			</div>
    	</div>
	</li>
	{{/each}}
