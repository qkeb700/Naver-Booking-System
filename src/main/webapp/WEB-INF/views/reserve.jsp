...
<div class="qty_info_icon"> <strong class="product_amount"> <span>{{changeType this.priceTypeName}}</span> </strong> <strong class="product_price"> <span class="price">10,200</span> <span class="price_type">원</span> </strong> <em class="product_dsc">10,200원 (15% 할인가)</em> </div>
</div>
{{/each}}
</script>
