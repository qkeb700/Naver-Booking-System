                ...
                <div class="section_booking_form">
                            ...
                            <form class="form_horizontal">
                                ...
                                <div class="inline_form last"> <label class="label" for="message">예매내용</label>
                                    <div class="inline_control">
                                        <p class="inline_txt selected"><span id="reservationDate">${randomDateText }</span>, 총 <span id="totalCount">0</span>매</p>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="section_booking_agreement">
                        ...
                        <div class="agreement"> <span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i> <span>개인정보 수집 및 이용 동의</span> </span>
                            <a href="javascript:void(0)" class="btn_agreement"> <span class="btn_text">보기</span> <i class="fn fn-down2"></i> </a>
...
<script type="myTemplate" id="reserveTemplate" >
{{#each productPrices}}
<div class="qty" data-productpriceid="{{this.productPriceId}}">
<div class="count_control">
    <!-- [D] 수량이 최소 값이 일때 ico_minus3, count_control_input에 disabled 각각 추가, 수량이 최대 값일 때는 ico_plus3에 disabled 추가 -->
    <div class="clearfix">
        <a href="javascript:void(0)" class="btn_plus_minus spr_book2 ico_minus3 disabled" title="빼기"> </a> <input type="tel" data-productPriceId={{this.productPriceId}} class="count_control_input disabled" value="0" readonly title="수량">
        <a href="javascript:void(0)" class="btn_plus_minus spr_book2 ico_plus3" title="더하기">
        </a>
    </div>
    <!-- [D] 금액이 0 이상이면 individual_price에 on_color 추가 -->
    <div class="individual_price"><span class="total_price on_color">0</span><span class="price_type">원</span></div>
</div>
<div class="qty_info_icon"> <strong class="product_amount"> <span>{{changeType this.priceTypeName}}</span> </strong> <strong class="product_price"> <span class="price">{{numberPoint this.price}} 원</span></strong> <em class="product_dsc">{{numberPoint price}}원 ({{this.discountRate}}% 할인가)</em> </div>
</div>
{{/each}}
</script>
