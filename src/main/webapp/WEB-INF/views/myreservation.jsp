...
<body>
	<input type="hidden" id="reservation_email"
		value="${sessionScope.loginInfo }" />
	<div id="container">
		<div class="header">
			<header class="header_tit">
				...
				<c:if test="${sessionScope.loginInfo != null }">
					<a href="#" class="btn_my"> <span title="내예약"
						class="viewReservation">${sessionScope.loginInfo }</span>
					</a>
...
<script type="myTemplate" id="reservationArticle">
				...
				<div class="card_detail">
					...
					<ul class="detail">
						...
						<li class="item"><span class="item_tit">내역</span> <em
							class="item_dsc"> {{productContent}} </em></li>
						<li class="item"><span class="item_tit">장소</span> <em
							class="item_dsc"> {{placeLot}} </em></li>
...
<script type="myTemplate" id="cardDescription">
	<div class=link_booking_details>
		<div class="card_header">
			<div class="left"></div>
			<div class="middle">
